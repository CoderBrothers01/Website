...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const whatsappContact = document.querySelector('.contact-method:nth-child(2)');
    if (whatsappContact) {
    ...
    const telegramContact = document.querySelector('.contact-method:nth-child(3)');
    if (telegramContact) {
...
function initializeWhatsApp() {
    ...
    if (whatsappFloat) {
        whatsappFloat.addEventListener('click', function() {
            const message = encodeURIComponent('Hello! I\'m interested in your services. Can you help me with a project?');
            const phone = '+919876543210'; // Replace with your actual WhatsApp number
